    ...
    >
      ...
      {hierarchy.length > 0 && (
        <div
          id={`${id}-hierarchy`}
          aria-hidden="true"
          className="mt-1 truncate text-2xs whitespace-nowrap text-muted-foreground"
        >
        ...
        >
          <div {...autocomplete.getRootProps({})}>
            ...
            >
              ...
              <div
                ref={panelRef}
                className="border-t border-border bg-white empty:hidden dark:border-zinc-100/5 dark:bg-white/2.5"
